...
#[allow(non_upper_case_globals)]
pub mod EntrySh {
    pub const ISh: u64 = 0b11; // Inner Shareable
    pub const OSh: u64 = 0b10; // Outer Shareable
}

#[allow(non_snake_case)]
#[allow(non_upper_case_globals)]
pub mod EntryAttr {
    pub const Mem: u64 = 0b000; // Normal Memory
    pub const Dev: u64 = 0b001; // Device Memory
    pub const Nc: u64 = 0b010; // Non-cacheable
}
